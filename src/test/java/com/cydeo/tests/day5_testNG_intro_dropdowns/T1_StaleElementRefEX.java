...
WebElement deletButton = driver.findElement(By.xpath("//button[@class='added-manually']"));
        System.out.println("deletButton.isDisplayed() = " + deletButton.isDisplayed());
...
// WE COULD NOT LOCATE BECAUSE THE ELEMENTE  COMPLETLY DELETED
        try {
            System.out.println("deletButton.isDisplayed() = " + deletButton.isDisplayed());
